...
const AdminList = () => {
  ...
  const updateAdmin = () => {
    ...
    fetch(`https://restaurant-server5.onrender.com/updateAdmin/${updateID}`, {
      method: "PATCH",
  ...
  const deleteAdmin = (id) => {
    // console.log(id);
    fetch(`https://restaurant-server5.onrender.com/deleteAdmin/${id}`, {
      method: "DELETE",
    });
  };
          ...
          {admin.map((admins) => (
            <tbody>
              <tr>
                ...
                <td>
                  <Button
                    onClick={() => deleteAdmin(admins._id)}
                    variant="danger"
                  >
                    Delete
                  </Button>
